 ...
 */
public class DirectionalSynchronizerSlavePonderPlugin implements PonderPlugin {
    ...
    public void registerScenes(PonderSceneRegistrationHelper<ResourceLocation> helper) {
        helper.forComponents(ResourceLocation.parse("aero_reformation:directional_synchronizer_slave"))
            .addStoryBoard("ponderer:tbq3", DirectionalSynchronizerSlaveScenes::directional_synchronizer_slave_p1);
        helper.forComponents(ResourceLocation.parse("aero_reformation:directional_synchronizer_slave"))
            .addStoryBoard("ponderer:tbq4", DirectionalSynchronizerSlaveScenes::directional_synchronizer_slave_p2);
    }
